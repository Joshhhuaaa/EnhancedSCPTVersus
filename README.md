...
The command script will automatically mount the disc image and launch the game. When the game closes, the command script will also unmount the disc image. If you need to mount the disc image manually, you can find it at: `System\_PC_\Enhanced\Mount.iso`.
